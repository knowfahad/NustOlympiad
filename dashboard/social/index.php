...
$stmt = $conn->prepare("select e.EventID, e.Name from events as e where e.EventType = 2 and e.EventID not in (select ep.EventID from eventparticipants as ep where ep.ParticipantCNIC = ?)");
