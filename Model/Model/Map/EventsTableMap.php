...
class EventsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Model.Model.Map.EventsTableMap';
     ...
     */
    const OM_CLASS = '\\Model\\Model\\Events';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Model.Model.Events';
    ...
    /**
     * the column name for the EventFee field
     */
    const COL_EVENTFEE = 'events.EventFee';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Eventid', 'Name', 'Eventfee', 'Eventtype', ),
        self::TYPE_CAMELNAME     => array('eventid', 'name', 'eventfee', 'eventtype', ),
        self::TYPE_COLNAME       => array(EventsTableMap::COL_EVENTID, EventsTableMap::COL_NAME, EventsTableMap::COL_EVENTFEE, EventsTableMap::COL_EVENTTYPE, ),
        self::TYPE_FIELDNAME     => array('EventID', 'Name', 'EventFee', 'EventType', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Eventid' => 0, 'Name' => 1, 'Eventfee' => 2, 'Eventtype' => 3, ),
        self::TYPE_CAMELNAME     => array('eventid' => 0, 'name' => 1, 'eventfee' => 2, 'eventtype' => 3, ),
        self::TYPE_COLNAME       => array(EventsTableMap::COL_EVENTID => 0, EventsTableMap::COL_NAME => 1, EventsTableMap::COL_EVENTFEE => 2, EventsTableMap::COL_EVENTTYPE => 3, ),
        self::TYPE_FIELDNAME     => array('EventID' => 0, 'Name' => 1, 'EventFee' => 2, 'EventType' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Model\\Model\\Events');
        ...
        $this->addColumn('EventFee', 'Eventfee', 'INTEGER', true, 10, null);
        $this->addColumn('EventType', 'Eventtype', 'INTEGER', true, 1, null);
    } // initialize()
...
), null, 'CASCADE', 'Eventparticipantss', false);
    } // buildRelations()
    /**
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Model\Model\Events) { // it's a model object
