...
/**
 * Base class that represents a row from the 'ambassador_participant' table.
 *
 *
 *
 * @package    propel.generator.Model.Model.Base
 */
abstract class AmbassadorParticipant implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Model\\Map\\AmbassadorParticipantTableMap';
    ...
    /**
     * The value for the participantcnic field.
     *
     * @var        string
     */
    protected $participantcnic;
    ...
    /**
     * Initializes internal state of Model\Model\Base\AmbassadorParticipant object.
     */
    ...
    /**
     * Compares this with another <code>AmbassadorParticipant</code> instance.  If
     * <code>obj</code> is an instance of <code>AmbassadorParticipant</code>, delegates to
     * <code>equals(AmbassadorParticipant)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|AmbassadorParticipant The current object, for fluid interface
     */
    ...
    /**
     * Get the [participantcnic] column value.
     *
     * @return string
     */
    public function getParticipantcnic()
    {
        return $this->participantcnic;
    }
     ...
     * @return $this|\Model\Model\AmbassadorParticipant The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[AmbassadorParticipantTableMap::COL_ID] = true;
        }
    ...
    /**
     * Set the value of [participantcnic] column.
     *
     * @param string $v new value
     * @return $this|\Model\Model\AmbassadorParticipant The current object (for fluent API support)
     */
    public function setParticipantcnic($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->participantcnic !== $v) {
            $this->participantcnic = $v;
            $this->modifiedColumns[AmbassadorParticipantTableMap::COL_PARTICIPANTCNIC] = true;
        }
    ...
    public function setAmbassadorid($v)
    {
        ...
        if ($this->ambassadorid !== $v) {
            $this->ambassadorid = $v;
            $this->modifiedColumns[AmbassadorParticipantTableMap::COL_AMBASSADORID] = true;
        }
    ...
    public function setEventid($v)
    {
        ...
        if ($this->eventid !== $v) {
            $this->eventid = $v;
            $this->modifiedColumns[AmbassadorParticipantTableMap::COL_EVENTID] = true;
        }
    ...
    public function setSportid($v)
    {
        ...
        if ($this->sportid !== $v) {
            $this->sportid = $v;
            $this->modifiedColumns[AmbassadorParticipantTableMap::COL_SPORTID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : AmbassadorParticipantTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : AmbassadorParticipantTableMap::translateFieldName('Participantcnic', TableMap::TYPE_PHPNAME, $indexType)];
            $this->participantcnic = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : AmbassadorParticipantTableMap::translateFieldName('Ambassadorid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ambassadorid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : AmbassadorParticipantTableMap::translateFieldName('Eventid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->eventid = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : AmbassadorParticipantTableMap::translateFieldName('Sportid', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 5; // 5 = AmbassadorParticipantTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Model\\Model\\AmbassadorParticipant'), 0, $e);
        }
    }
    ...
    {
        if ($this->aParticipant !== null && $this->participantcnic !== $this->aParticipant->getCnic()) {
            $this->aParticipant = null;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildAmbassadorParticipantQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see AmbassadorParticipant::setDeleted()
     * @see AmbassadorParticipant::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildAmbassadorParticipantQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                AmbassadorParticipantTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AmbassadorParticipantTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(AmbassadorParticipantTableMap::COL_PARTICIPANTCNIC)) {
            $modifiedColumns[':p' . $index++]  = 'ParticipantCNIC';
        }
        if ($this->isColumnModified(AmbassadorParticipantTableMap::COL_AMBASSADORID)) {
            $modifiedColumns[':p' . $index++]  = 'AmbassadorID';
        }
        if ($this->isColumnModified(AmbassadorParticipantTableMap::COL_EVENTID)) {
            $modifiedColumns[':p' . $index++]  = 'EventID';
        }
        if ($this->isColumnModified(AmbassadorParticipantTableMap::COL_SPORTID)) {
            $modifiedColumns[':p' . $index++]  = 'SportID';
        }

        $sql = sprintf(
            'INSERT INTO ambassador_participant (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'id':
                        ...
                        break;
                    case 'ParticipantCNIC':
                        $stmt->bindValue($identifier, $this->participantcnic, PDO::PARAM_STR);
                        break;
                    case 'AmbassadorID':
    ...
    {
        $pos = AmbassadorParticipantTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                return $this->getParticipantcnic();
                break;
            case 2:
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['AmbassadorParticipant'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['AmbassadorParticipant'][$this->hashCode()] = true;
        $keys = AmbassadorParticipantTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getParticipantcnic(),
            $keys[2] => $this->getAmbassadorid(),
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Model\Model\AmbassadorParticipant
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setParticipantcnic($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setAmbassadorid($arr[$keys[2]]);
        }
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\Model\AmbassadorParticipant The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(AmbassadorParticipantTableMap::DATABASE_NAME);

        if ($this->isColumnModified(AmbassadorParticipantTableMap::COL_ID)) {
            $criteria->add(AmbassadorParticipantTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(AmbassadorParticipantTableMap::COL_PARTICIPANTCNIC)) {
            $criteria->add(AmbassadorParticipantTableMap::COL_PARTICIPANTCNIC, $this->participantcnic);
        }
        if ($this->isColumnModified(AmbassadorParticipantTableMap::COL_AMBASSADORID)) {
            $criteria->add(AmbassadorParticipantTableMap::COL_AMBASSADORID, $this->ambassadorid);
        }
        if ($this->isColumnModified(AmbassadorParticipantTableMap::COL_EVENTID)) {
            $criteria->add(AmbassadorParticipantTableMap::COL_EVENTID, $this->eventid);
        }
        if ($this->isColumnModified(AmbassadorParticipantTableMap::COL_SPORTID)) {
            $criteria->add(AmbassadorParticipantTableMap::COL_SPORTID, $this->sportid);
        }
    ...
    {
        $criteria = ChildAmbassadorParticipantQuery::create();
        $criteria->add(AmbassadorParticipantTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\Model\AmbassadorParticipant (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setParticipantcnic($this->getParticipantcnic());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\Model\AmbassadorParticipant Clone of current object.
     * @throws PropelException
     */
    ...
    public function setEvents(ChildEvents $v = null)
    {
        ...
        if ($v !== null) {
            $v->addAmbassadorParticipant($this);
        }
    ...
    public function getEvents(ConnectionInterface $con = null)
    {
        if ($this->aEvents === null && ($this->eventid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aEvents->addAmbassadorParticipants($this);
             */
        }
    ...
    {
        if ($v === null) {
            $this->setParticipantcnic(NULL);
        } else {
            $this->setParticipantcnic($v->getCnic());
        }
    ...
    {
        if ($this->aParticipant === null && (($this->participantcnic !== "" && $this->participantcnic !== null))) {
            $this->aParticipant = ChildParticipantQuery::create()
                ->filterByAmbassadorParticipant($this) // here
                ->findOne($con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aParticipant->addAmbassadorParticipants($this);
             */
        }
    ...
    public function getAmbassador(ConnectionInterface $con = null)
    {
        if ($this->aAmbassador === null && (($this->ambassadorid !== "" && $this->ambassadorid !== null))) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aAmbassador->addAmbassadorParticipants($this);
             */
        }
    ...
    public function getSports(ConnectionInterface $con = null)
    {
        if ($this->aSports === null && ($this->sportid !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aSports->addAmbassadorParticipants($this);
             */
        }
    ...
    {
        if (null !== $this->aEvents) {
            $this->aEvents->removeAmbassadorParticipant($this);
        }
        if (null !== $this->aParticipant) {
            $this->aParticipant->removeAmbassadorParticipant($this);
        }
        if (null !== $this->aAmbassador) {
            $this->aAmbassador->removeAmbassadorParticipant($this);
        }
        if (null !== $this->aSports) {
            $this->aSports->removeAmbassadorParticipant($this);
        }
        $this->id = null;
        $this->participantcnic = null;
    ...
    {
        return (string) $this->exportTo(AmbassadorParticipantTableMap::DEFAULT_STRING_FORMAT);
    }
