...
if($formsubmitted){
    ...
    if(strlen($challanid)){
        ...
        if(!$stmt->rowCount()){
            $errors[] = "Wrong Social Challan ID.";
        }
        else{
            var_dump ($challan = ($stmt->fetchAll(PDO::FETCH_OBJ)[0]));
        }
    }
                                ...
                                <div class="left-side-inner">
                                    ...
                                    <ul class="nav nav-pills nav-stacked custom-nav">
                                        ...
                                        <li class=" nav-active current"><a href="/oladmin/registration"><i class="ion ion-laptop"></i> <span>Registration Challan</span></a>
										  ...
										  <li class=" nav-active current"><a href="#"><i class="ion ion-laptop"></i> <span>Socials</span></a>
                                        </li>
