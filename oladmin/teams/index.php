...
if($formsubmitted){
    ...
    if(strlen($challanid)){
        $stmt = $mpdo->prepare("select * from challan as c inner join sportsteam as t on c.ChallanID = t.ChallanID  where t.ChallanID = ?");
        $stmt->execute([$challanid]);
        if(!$stmt->rowCount()){
            $errors[] = "Wrong Team Challan ID.";
        }
        else{
                                ...
                                <div class="left-side-inner">
                                    ...
                                    <ul class="nav nav-pills nav-stacked custom-nav">
                                        ...
                                        <li class=" nav-active current"><a href="/oladmin/registration"><i class="ion ion-laptop"></i> <span>Registration Challan</span></a>
										  ...
										  <li class="  nav-active current"><a href="#"><i class="ion ion-laptop"></i> <span>Team Challan</span> 
                                        </li></a>
										  ...
										  <li class=" nav-active current"><a href="disapprove"><i class="ion ion-laptop"></i> <span>Disapprove Challan</span></a>
                                        </li>
