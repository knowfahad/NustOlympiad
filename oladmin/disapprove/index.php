...
if($formsubmitted){
    ...
    if(strlen($challanid)){
        $stmt = $mpdo->prepare("select * from challan as c where c.ChallanID = ?");
        $stmt->execute([$challanid]);
        if(!$stmt->rowCount()){
            $errors[] = "Wrong Challan ID.";
        }
        else{
    ...
    elseif( strlen($approve) ){
        ...
        $stmt = $mpdo->prepare("update challan set PaymentStatus = 0 where ChallanID = ?");
...
<html>
    <head>
        ...
        <title>Disapprove Challans</title>
                                ...
                                <div class="left-side-inner">
                                    ...
                                    <ul class="nav nav-pills nav-stacked custom-nav">
                                        ...
                                        <li class=" nav-active current"><a href="/oladmin/registration"><i class="ion ion-laptop"></i> <span>Registration Challan</span></a>
										  ...
										  <li class=" nav-active current"><a href="/oladmin/individual"><i class="ion ion-laptop"></i> <span>Individual Challan</span></a>
                                        </li>
										
										  <li class=" nav-active current"><a href="/oladmin/socials"><i class="ion ion-laptop"></i> <span>Socials</span></a>
                                        </li>
										
										  <li class=" nav-active current"><a href="#"><i class="ion ion-laptop"></i> <span>Accomodation Challan</span></a>
                                        </li>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php if(!$challan->PaymentStatus): ?>
                                            <button disabled class="btn btn-primary">Not approved!</button>
                                        <?php else: ?>
                                            <form method="POST">
