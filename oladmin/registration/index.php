...
if($formsubmitted){
    ...
    if(strlen($challanid)){
        $stmt = $mpdo->prepare("select * from challan as c inner join participant as p on c.ChallanID = p.RegistrationChallanID  where ChallanID = ?");
        $stmt->execute([$challanid]);
        if(!$stmt->rowCount()){
            $errors[] = "Wrong Registration Challan ID.";
        }
        else{
...
<html>
    <head>
        ...
        <title>Registration Challan </title>
                            ...
                            <div class="left-side sticky-left-side">
                                <div class="left-side-inner">
                                    ...
                                    <ul class="nav nav-pills nav-stacked custom-nav">
                                        ...
                                        <li class=" nav-active current"><a href="#"><i class="ion ion-laptop"></i> <span>Registration Challan</span></a>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <td><?=$challan->FirstName . " " . $challan->LastName?></td>
