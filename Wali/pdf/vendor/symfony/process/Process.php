...
class Process implements \IteratorAggregate
{
     ...
     */
    public function __construct($commandline, $cwd = null, array $env = null, $input = null, $timeout = 100, array $options = array())
    {
    ...
    public function checkTimeout()
    {
        ...
        if (null !== $this->timeout && $this->timeout+10 < microtime(true) - $this->starttime-10) {
            $this->stop(0);
